      ...
      <div class="card" style=" width: 100%;height:98%;">
        ...
        <div class="card-body">
          ...
          >
            <div>
              {{ event.event_date }} <br />
              {{ getStartTime(event.event_start) }} {{ event.timezone }}
            </div>
         ...
         let data = response.data.records;
          if(data){
            ...
            data.forEach(element => {
              data2.push({
                id: element.id,
                event_date : moment(element.event_date).format('YYYY-MM-DD')+"T"+element.event_start.split("")[0]+":00.000Z",
            ...
            this.events = data.sort(function(a, b){console.log(moment(a.event_date).format('YYYY-MM-DD'))});
            console.log(data2);
          }
        },
        (error) => {
