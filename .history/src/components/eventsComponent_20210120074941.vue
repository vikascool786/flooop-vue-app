...
<div class="row">
          <div v-for="(event,index) in events" style="padding-top: 22px;" class="col-lg-4 col-md-6 col-12" :key="index">
            <div class="card" style=" width: 100%;height:98%;">
              <div @click="redirectToDetail(event.id)"  style="margin:14px;" class="row">
                <div
              ...
              <img @click="redirectToDetail(event.id)"  style="width:100%;border-radius:10px;height: 140px;" :src="event.path" />
              <div class="card-body">
                <div @click="redirectToDetail(event.id)"  style="color:#929292;margin-top: 5px;letter-spacing:1.5px;" class="card-text">
                  <div>{{event.event_date }} <br> {{getStartTime(event.event_start) }}  {{event.timezone}}</div>
                ...
                <div style="padding-top: 20px;">
                  <button v-if="event.flag_joined == null || event.flag_joined == '0'"
                    id="button"
                  ...
                  >JOIN</button>
                  <button v-if="event.flag_joined == '1'"
                    id="button"
