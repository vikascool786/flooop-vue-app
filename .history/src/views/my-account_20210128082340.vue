<template>
  <div style="padding-right: 4vw;padding-left: 4vw;" class=" py-xl-4 py-lg-2">
    ...
    >
      ...
      >
        ...
        >
          ...
          <br />{{ event.event_date ? (event.event_date).split(",")[0] : event.event_date }}<br>{{ event.event_date ? (event.event_date).split(",")[1] : event.event_date}}<br>
        </p>
      </div>
      <div
        style="padding-top:10px;text-align:left;"
    ...
    <div v-for="(event, index) in events_host" :key="index" style="padding:10px;" class="row">
      <div
        style="padding-top:10px;text-align:center;"
        class="col-lg-1 col-md-4 col-4"
      >
