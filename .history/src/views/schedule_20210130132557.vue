<template>
  <div class="container">
    ...
    <div class="row">
        <div class="col-md-1">
          <span data-v-6f6cad31="" style="color: #999; font-size: 16px; text-align: center; display: inline-block; width: 100%;">
          < 
          </span>
          </div>
        <div class="col-md-10">
          <span data-v-6f6cad31="" style="color: rgb(38, 118, 169); font-size: 16px; text-align: center; display: inline-block; width: 100%;">
          < 
          </span>
        </div>
        <div class="col-md-1">
