<template>
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
          <VueSlickCarousel :arrows="true" :dots="false" :slidesToShow="2" :slidesToScroll="2">
           <div
    ...
    <span  v-for="(event, index) in eventGroups" :key="index">
      <div class="row">
          <div class="col-md-12">
              <p style="background: #F8BD40; color: rgb(38, 118, 169); margin-top: 3npm i vue-slick-carousel0px; padding-left: 10px;">{{event.date}}</p>
          </div>
      </div>
