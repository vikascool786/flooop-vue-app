  ...
  <div class="level-item has-text-centered">
    ...
    <div style="width: 100%;" class="ads-grid py-sm-6 py-6">
        ...
        <div style="padding-right: 0px !important;padding-left: 0px !important;" class="col-lg-12">
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <ol style="    width: -webkit-fill-available;" class="carousel-indicators">
              <li v-for="(slide,index) in slides" data-target="#myCarousel" :data-slide-to="index" :key="index" class="active"></li>
            </ol>
      ...
      <div style="padding-right: 4vw;padding-left: 4vw;" class="py-xl-4 py-lg-2">
        ...
        <br />
        <div class="row">
          <div style="" class="col-md-4 col-4 live-and-upcoming-hr">
            <hr style="background-color: rgb(247 114 57); height: 0.01em;" />
          </div>
          <div style="text:align:center;" class="col-md-4 col-4 live-and-upcoming">
            <span
              class="home-sub-heading"
            >LIVE AND UPCOMING</span>
          </div>
          <div style="flex: 1 0 33.333333%;max-width: 38.333333%;" class="col-md-4 col-4">
            <hr style="background-color: rgb(247 114 57);    height: 0.01em;" />
          </div>
        </div>
        <br />
...
.live-and-upcoming-hr{
  flex: 1 0 33.333333%;max-width: auto;
}
}
</style>
