<template>
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
          <span v-for="(eventlist, index) in event.events" :key="index" style="color: rgb(38, 118, 169); font-size: 16px; text-align: center; display: inline-block; width: 100%;">
            {{eventlist.event_date2}}
          </span>
        </div>
        <div class="col-md-1">
