    ...
    getEventStatus: function () {
      ...
      EventService.getEvent(id).then(
        (response) => {
          ...
          let data = [];
          let now = moment();
console.log(now.format().split("+")[0]);
let d1 = moment('2021-01-29T02:11:41');
let d2 = moment('2018-06-30T02:11:41');
              ...
              data.push(
                {
                  ...
                  'event_ampm' : element.event_ampm,
                  'event_attendees' : element.event_attendees,
                  'event_attendees2' : element.event_attendees2,
                  'event_attendees_do' : element.event_attendees_do,
                  'event_categories' : element.event_categories,
                  'event_cohost' : element.event_cohost,
                  'event_conversations' : element.event_conversations,
                  ...
                  'event_hosts' : element.event_hosts,
                  ...
                  'event_rating' : element.event_rating,
                  'event_reviews' : element.event_reviews,
                  'event_reviews_count' : element.event_reviews_count,
                  'event_start' : element.event_start,
                  'event_start_hours' : element.event_start_hours,
                  'event_start_minutes' : element.event_start_minutes,
                  'event_tags' : element.event_tags,
                  'event_things_to_keep' :element.event_things_to_keep,
                  ...
                  'timezone_id' : element.timezone_id,
                }
              )
            }
