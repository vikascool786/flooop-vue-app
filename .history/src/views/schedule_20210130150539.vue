    ...
    <span  v-for="(event, index) in eventGroups" :key="index">
      ...
      <div class="row" style="margin-top: 40px;" v-for="(eventlist, index) in event.events" :key="index">
        ...
        >
          ...
          >
           {{eventlistevent_start === "00:00 " || eventlist.event_start === "00:00" || eventlist.event_start === "00:00 AM" || eventlist.event_start === "00:00 PM") ? eventlist.event_start : getStartTime(event.event_start) }} {{ event.timezone }} {{eventlist.timezone}}
            <br />
