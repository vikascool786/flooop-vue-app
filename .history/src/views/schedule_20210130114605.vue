<template>
  <div class="container">
    <div class="row" style="margin-top: 80px;">
        <div class="col-md-12">
            <ul class="category-view">
                <li>
                    <img src="http://floooplife.com/flooopadmin/upload/category/default.jpg" style="width: 100%; object-fit: cover;"/><br>
    ...
    <div class="row">
        <div class="col-md-12">
            <p style="background: #F8BD40; color: rgb(38, 118, 169); margin-top: 80px; padding-left: 10px;">Wednesday, 23 July 2020</p>
        </div>
    </div>
...
export default {
  ...
  data: function() {
    return {
      ...
      slides : [],
      isActive:false,
      url: "http://floooplife.com/flooopadmin",
    };
  },
   filters: {
        truncate: function (text, length, suffix) {
