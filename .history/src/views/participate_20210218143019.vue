  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 mt-5 mb-5">
        ...
        <h1>How Flooop.Life helps to protect your privacy when you use Zoom:</h1><br><br>
<p>
- A random, password-protected meeting ID is created for each experience<br>
- Virtual events cannot be recorded through Zoom<br>
- Guests cannot share their screens during the virtual event.<br>
- Files cannot be transferred through Zoom<br>
- The "waiting room" feature is on by default, allowing hosts to admit guests into the Zoom meeting room individually<br><br><br></p>

Tips to help you protect your privacy:<br><br>

- Don’t share the password-protected Zoom meeting link with anyone else<br>
- Use the most up-to-date version of the Zoom app<br>
- Be aware of your surroundings and what’s behind you when you are on camera – your host and other guests will be able to see it<br>
- Mute yourself until you’re ready to speak<br>
- Take care when using the group chat feature as all participants will be able to read what you post<br>
- If you don’t want to provide your full name to the guests and hosts of your experience, you can input a different handle or use your first name only when logging into Zoom<br>
- Please do not screenshot or take photos of your host or other guests without their permission<br>
