  ...
  <div style="padding-right: 4vw;padding-left: 4vw;" class="py-xl-4 py-lg-2">
    <div class="row">
      <div style="text-align: center;" class="col-lg-12 col-md-12 col-12">
        <div style="width: 100%;height: 80%;margin: auto;">
          <div style="margin:14px;" class="row">
            <div
              style="font-size: 1.5em;font-weight: 600;color:#929292;letter-spacing:1.5px;color:#929292;letter-spacing:1.5px;    letter-spacing: 1.5px;"
              class="col-lg-12 col-md-12 col-12"
            >{{event.event_title}}</div>
          </div>
          <div class="background">
            <img style="width:100%;border-radius:15px;height:505px;" src="http://floooplife.com/flooopadmin/upload/category/default.jpg" />
            <!-- <img style="width:100%;border-radius:15px;height:505px;" :src="event.path" /> -->
            <div v-show="showmodal" class="overlay-box">
              <div class="row" style="height: -webkit-fill-available;">
                <div style="text-align: center;" class="col-lg-12 col-md-12 col-12"></div>
                <div style="text-align: center;" class="col-lg-12 col-md-12 col-12">
                  <span
                    style="font-size: 1.7vw;font-weight: 500;letter-spacing: 1.5px;color:#929292;"
                  >We're excited to see you!</span>
                </div>
                <span style="position: absolute; top: 7px; right: 20px; font-size: 20px;cursor: pointer;" @click="closeModal()">X</span>
                <div style="text-align: center;" class="col-lg-12 col-md-12 col-12">
                  <span
                ...
                <div style="text-align: center;" class="col-lg-12 col-md-12 col-12">
                  <span
                    style="font-size: 1.5vw;font-weight: 400;color:#999;color:#929292;letter-spacing: 1.5px;"
                  >{{event.event_title}}</span>
                </div>
                <div style="text-align: center;     " class="col-lg-12 col-md-12 col-12">
                  <div
                    style="font-size: 1.2vw;font-weight: 500; color:#929292; letter-spacing: 1.5px;"
                    class="card-text"
                  >
                    <div style="line-height: 50px;">{{event.event_date}} @ {{getStartTime(event.event_start)}} {{event.timezone}}</div>
                    <div style="line-height: 50px;">{{event.event_duration}}</div>
                  </div>
                </div>
                <div style="text-align: center;" class="col-lg-12 col-md-12 col-12" title="Do you need to cancel?">
                  <button
                    id="button"
                    style="width: 35%;font-size:1vw;letter-spacing: 1.5px;height:3.5vw;border-radius: 20px;color: #ff8354;border-color: #ff8354;font-weight: 500;"
                    type="button"
                ...
                <div style="    text-align: center;     " class="col-lg-12 col-md-12 col-12">
                  <div
                    style="font-size: 1vw;font-weight: 600;    letter-spacing: 1.5px;"
                  >Add to Calendar</div>
                  <div style="padding-top: 5px;">
                    <span
                      style="font-weight: 500;margin-left: 15px;font-size: 1vw;color: rgb(240 76 76);;    letter-spacing: 1.5px;"
                    >iCal</span>
                    <span
          ...
          <div class="card-body">
            <div
              style="color:#929292;letter-spacing:1.5px;margin-top: 5px;font-size: larger;    letter-spacing: 1.5px;"
              class="card-text"
            >
              <div
                style="line-height: 40px;"
              >{{event.event_date}} @ {{getStartTime(event.event_start)}} {{event.timezone}}</div>
              <div style="line-height: 35px;">{{event.event_cost_label}}</div>
              <div style="line-height: 35px;">{{event.event_duration}}</div>
              <div style="line-height: 35px;" v-if="event.event_lang_label.lenght > 0">Language:{{event.event_lang_label}}</div>
              <div style="line-height: 35px; color:#f00" v-if="event.event_countdown_label.lenght > 0">{{event.event_countdown_label}}</div>
            </div>
            <div style="padding-top: 16px;" class="row">
              <div class="col-lg-12 col-md-12 col-12">
                ...
                ></i>
                  <a class="twitter-share-button-x customer share" 
                ...
                <i
                  ...
                  class="far fa-heart" v-bind:class="{ active: event.flag_fav==='1' }"
      ...
      >
        <button
          id="button"
          v-if="eventJoined == false || eventJoined ==  null || eventJoined == '0'"
          style="letter-spacing: 1.5px;width: 100%;border-radius: 15px;color: #ff8354;border-color: #ff8354; font-weight: 500;
      ...
      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8">
        ...
        <br />
        <span
          style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
      ...
      >
        <br />
        <br />
        <div style="color:#929292;letter-spacing:1.5px;">{{event.event_desc}}</div>
      </div>

      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8" v-if="event.event_attendees_do.length > 0 || event.event_attendees_do || event.event_attendees_do !== '' || event.event_attendees_do !== null">
        <br />
        <br />
        <span  v-if="event.event_attendees_do.length > 0"
          style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
        >What to bring</span>
      </div>
      <div
        style="text-align: left; color:#929292;letter-spacing:1.5px;"
        class="col-lg-8 col-md-12 col-12"
        v-if="event.event_attendees_do.length > 0 || event.event_attendees_do || event.event_attendees_do !== '' || event.event_attendees_do !== null"
      >
        <br />
        <br />
        <div style="color:#929292;letter-spacing:1.5px;"  v-if="event.event_attendees_do.length > 0">{{event.event_attendees_do}}</div>
      </div>
      ...
      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8">
        ...
        <div class="row">
          <div
            style="text-align: left;padding-right: 14px !important;padding-left: 14px !important;"
            class="col-lg-8 col-md-12 col-12"
          >
            <span
              style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
            ...
            <div v-for="(host, index) in event.event_hosts" :key="index">
              <img style="width: 14.5em;border-radius:15px; height: 150px;" :src="host.path_img" />
              <br />
              <div style="padding-top: 8px;padding-right: 5px;text-align:center;">
                <span
                  style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
      ...
      <div
        v-for="(host, index) in event.event_hosts" :key="index"
        style=" text-align: left;   color:#929292;letter-spacing:1.5px;    height: fit-content;"
        class="col-lg-8 col-md-12 col-12"
      >
        <br />
        <br />
        <div style="color:#929292;letter-spacing:1.5px;">{{host.message}}</div>
      </div>

      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8" v-if="event.display_attendees ==='yes'">
        <br />
        <br />
        <span
          style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
      ...
      >
        ...
        <div class="row">
          ...
          <!-- <div
            v-for="(attendee,index) in event.event_attendees" :key="index"
            style="height: 190px;"
            class="col-lg-4 col-md-6 col-8"
          >
            <img style="width: 15em;height: 150px;border-radius:15px;" :src="attendee.path_img" />
      ...
      >
        ...
        <div class="row">
          <div
            v-for="attendee in event.event_attendees"
            style="height: 190px;"
            class="col-lg-4 col-md-6 col-8"
          >
            <img
      ...
      >
        ...
        <br />
        <div class="row">
          <div v-for="conversation in event.event_conversations">
            <div
            ...
            >
              <img
                style="width: 15em; height: 150px;border-radius:15px;"
                :src="conversation.path_img"
              />
              <div style="text-align: center;">
                <div
                  style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
                >{{conversation.first_name}} {{conversation.last_name}}</div>
              </div>
            </div>
            <div
              style=" text-align: left;color:#929292;letter-spacing:1.5px;height: fit-content;"
      ...
      >
        ...
        <br />
        <div class="row">
          <div v-for="(conversation, index) in event.event_conversations" :key="index">
            <div
              style="text-align: left;color:#929292;letter-spacing:1.5px;height: 190px;"
              class="col-lg-4 col-md-8 col-8"
            >
      ...
      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8">
        <br />
        <br />
        <span style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;">Reviews</span>
        <br />
        <span
      ...
      >
        ...
        <div v-for="(review, index) in event.event_reviews" :key="index">
          <div class="row">
            <div style="text-align: left;" class="col-lg-4 col-md-8 col-8">
              <img style="width: 15em; height: 150px; border-radius: 15px;" :src="review.path_img" />
            </div>
            <div
              style="text-align: left;padding-right: 14px !important;padding-left: 24px !important;"
              class="col-lg-8 col-md-12 col-12"
            >
              <span style="font-size: large;font-weight: 600;">{{review.first_name}}</span>
              {{review.review_date}}
              <br />
              <img style="width: 18%;" :src="require('../assets/images/star.png')" />
            </div>
            <br />
          </div>
          <br />
      ...
      >
        ...
        <br />
        <div class="row">
          <div class="col-lg-12 col-md-12 col-12">{{event.event_things_to_keep}}</div>
        </div>
        <br />
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getEventStatus: function() {
      ...
      if(AuthService.isLoggedIn() == true){
        ...
        response => {
          ...
          if (this.eventJoined == false || this.eventJoined == null || this.eventJoined == '0') {
            this.showmodal = false;
          } else {
             this.showmodal = true;
             setTimeout(() => {
    ...
    addGoogleCal()
    {
      var isSignedIn = gapi.auth2.getAuthInstance().isSignedIn.get(); console.log('isSignedIn:'+isSignedIn);
      if(!isSignedIn){
    ...
    initClient() {
       ...
       var clientId = '430299638290-0ncq4i2q1n6j40vvr4m2ic5f4rlbpjt6.apps.googleusercontent.com'; 
  ...
  mounted() {
   this.getEventStatus();
   let firstTimeLand = localStorage.getItem("joinedStatus");
   if(firstTimeLand === "firstTime"){
     this.showmodal === true;
   }
   },
   created() {
