<template>
  <div class="container">
    ...
    <div class="row">
        <div class="col-md-1">
          <span style="color: #999; font-size: 16px; text-align: center; display: inline-block; width: 100%;">
          < 
          </span>
          </div>
        <div class="col-md-10">
          <ul style="display:inline-block; list-style:none;">
            <li
              style="list-style:none; display: inline-block; color: rgb(38, 118, 169); font-size: 16px; text-align: center; display: inline-block; padding: 5px;" 
              v-for="(event, index) in eventGroups" :key="index" >
               <span style="text-transform: uppercase;">{{ event.date.split(", ")[0].split(/\s+/).slice(1,3) }}</span> {{event.date.split(", ")[1].split(" ")[1]}}
              </li> 
          </ul>
        </div>
        <div class="col-md-1">
