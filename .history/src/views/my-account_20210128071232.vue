<template>
      <div style="padding-right: 4vw;padding-left: 4vw;" class=" py-xl-4 py-lg-2">
        <div class="row">
          <div class="col-lg-5 col-md-5 col-12">
            ...
            <div class="row">
              <div style="text-align: center;" class="col-lg-6 col-md-6 col-12">
                <span
                  style="font-size: 1.2rem;font-weight: 400;color:#929292;letter-spacing: 1.5px;"
                >{{user.first_name}} {{user.last_name}} vikas wankhede</span>
                  </div>
            </div>
            ...
            <div class="row">
              <div style="text-align: center;    padding-top: 10px;" class="col-lg-6 col-md-6 col-12">
            <span
              style="font-size: 1.2em;font-weight: 400;color:#929292;letter-spacing: 1.5px;"
            >Edit Profile</span>
            <br />
                  </div>
            </div>
          ...
          <div v-show='showmodal' class="col-lg-5 col-md-6 col-12">
              <br>
            <div style="border: 2px solid lightgray;border-radius: 15px;text-align: center;margin-top: 12px;" class="row">
              ...
              <div class="col-lg-12 col-md-12 col-12">
                <div class="row">
                  ...
                  <div class="col-lg-5 col-md-5 col-12">
                    ...
                    <br />
                      <div class="row">
                  <div style="padding-top: 15px;" class="col-lg-12 col-md-12 col-12">
                    <i
                      class="fab fa-facebook-square"
                      style="font-size:24px;color:#47639f;margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="fab fa-twitter-square"
                      style="font-size:24px;color:#6ab6f0;margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="fas fa-envelope"
                      style="font-size:24px;color:rgb(168 162 162);;margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="fas fa-comment-alt"
                      style="font-size:24px;color:rgb(242 203 68);margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="fab fa-whatsapp-square"
                      style="font-size:24px;color:#3cd15f;margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="fab fa-facebook-messenger"
                      style="font-size:24px;color:rgb(25 150 246);margin-left:10px; cursor: pointer;"></i>
                    <i
                      class="far fa-heart"
                      style="font-size:24px;color:lightgray;margin-left:10px; cursor: pointer;"></i>
                  </div>
                </div>
                  </div>
                </div>
           ...
           <br />
        <div class="row" v-for="event in events_attending" style="padding:10px;" >
          <div style="padding-top:10px;text-align:center;" class="col-lg-2 col-md-4 col-4">
            <p style="font-size: 1em;font-weight: 500;    letter-spacing: 1.5px;" class="card-text">
               {{event.event_start}}
              <br />{{event.event_date}}
            </p>
          </div>
          <div style="padding-top:10px;text-align:center;" class="col-lg-2 col-md-4 col-4 border">
            <img
              style="border-radius:15px;width: 150px;float: right;"
              :src="event.path"
            />
          </div>

          <div style="padding-top:10px;text-align:center;" class="col-lg-2 col-md-4 col-4">
            <p v-on:click="openEventDetail(event.id)" style="font-size: 1em;font-weight: 500;    letter-spacing: 1.5px;" class="card-text">
               {{event.event_title}}
            </p>
          </div>
          <div class="col-lg-6 col-md-6 col-12">
          <div style="padding-top:10px;text-align:center;display: inline-block;
    padding-right: 15px;" class="">
            <button id="button" 
              @click="OpenAttendees(event.id)" 
    ...
    padding-right: 15px;" class="">
          ...
          <div style="padding-top:10px;text-align:center;display: inline-block;
    padding-right: 15x; " class="">
            <button id="button" 
              style="width: 100%;border-radius:15px;color: #b1acac;border-color: #b1acac;font-weight: 500;font-size: 14px;"
              type="button"
              class="btn btn-outline-danger"
            >Join Event {{event.event_countdown_label2}}</button>
          </div>
          </div>
        </div>
        ...
        <div style="margin-top: 85px;margin-bottom: 85px;" class="row">
          <div class="col-lg-6 col-md-6 col-12">
            <span
              style="font-size: 1.3em;font-weight: 500;color:#929292;float: left;letter-spacing: 1.5px;line-height: 20px;"
            >Event I'm Hosting </span>
            <span style="color:#929292;padding-left: 15px;">
              <span  class="cursor_pointer" v-bind:class="{ active: hosting_events==='1' }" @click="getEventStatus('AccountMyEventsUpcoming')">upcoming</span> | 
              <span class="cursor_pointer" v-bind:class="{ active: hosting_events==='0' }" @click="getEventStatus('AccountMyEventsPast')">past</span></span>
          </div>
        </div>

       <div v-for="event in events_host" style="padding:10px;" class="row">
          <div style="padding-top:10px;text-align:center;" class="col-lg-1 col-md-4 col-4">
            <p style="font-size: 1em;font-weight: 500;    letter-spacing: 1.5px;" class="card-text">
               {{event.event_start}}
              <br />{{event.event_date}}
            </p>
          ...
          <div style="padding-top:10px;text-align:center;" class="col-lg-2 col-md-6 col-6">
            <button id="button" 
              @click="OpenAttendees(event.id)"
              style="width: 100%;border-radius: 15px;color: #b1acac;border-color: #b1acac;font-weight: 500;font-size: 14px;text-align: center;align-items: center;"
              type="button"
          ...
          <div v-if="showEventStart" style="padding-top:10px;text-align:center; " class="col-lg-2 col-md-6 col-6">
            <button id="button" 
              style="width: 100%;border-radius:15px;color: #b1acac;border-color: #b1acac;font-weight: 500;font-size: 14px;"
              type="button"
              class="btn btn-outline-danger"
            >Event Start {{event.event_countdown_label2}}</button>
          </div>
        </div>
        <b-modal :active.sync="isComponentModalActive" has-modal-card>
            ...
            <div class="modal-card" style="width: auto">
                ...
                <footer class="modal-card-foot">
                    <button class="button" type="button" @click="CloseInviteFriend()">Close</button>
            ...
            <div class="modal-card" style="width: auto">
                ...
                <section class="modal-card-body">
                    <div class="row">
                      ...
                      >
                        <img style="width: 5em;height: 80px;border-radius:15px;" :src="attendee.path_img" />
                ...
                <footer class="modal-card-foot">
                    <button class="button" type="button" @click="CloseAttendees()">Close</button>                    
                </footer>
            </div>
        </b-modal>
      </div>
...
span.active{color:rgb(255, 131, 84) !important}
</style>
