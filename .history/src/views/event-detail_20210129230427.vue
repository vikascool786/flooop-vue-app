<template>
  <div style="padding-right: 4vw;padding-left: 4vw;" class="py-xl-4 py-lg-2">
    <div class="row">
      ...
      <div style="text-align: left;" class="col-lg-4 col-md-8 col-8" v-if="event.event_attendees_do || event.event_attendees_do || event.event_attendees_do !== '' || event.event_attendees_do !== null">
        <br />
        <br />
        <span  v-if="event.event_attendees_do"
          style="font-size: large;font-weight: 600;color:#929292;letter-spacing:1.5px;"
        >What to bring</span>
      </div>
      <div
        style="text-align: left; color:#929292;letter-spacing:1.5px;"
        class="col-lg-8 col-md-12 col-12"
        v-if="event.event_attendees_do || event.event_attendees_do || event.event_attendees_do !== '' || event.event_attendees_do !== null"
      >
        <br />
        <br />
        <div style="color:#929292;letter-spacing:1.5px;"  v-if="event.event_attendees_do">{{event.event_attendees_do}}</div>
      </div>
