<template>
  <div style="padding-right: 4vw; padding-left: 4vw" class="py-xl-4 py-lg-2">
    <div class="row">
      ...
      <div
        v-if="isLoggedIn && event.display_attendees === ''"
        style="
          text-align: left;
          color: #929292;
          letter-spacing: 1.5px;
      ...
      <div class="col-lg-4 col-md-8 col-8">
          ...
          <p>Any experience can be cancelled and fully refunded within 24 hours of purchase, or at least 7 days before the experience starts.</p>
      </div>
       <div class="col-lg-4 col-md-8 col-8">
