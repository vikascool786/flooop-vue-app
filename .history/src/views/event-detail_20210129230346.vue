        ...
        <div style="width: 100%;height: 80%;margin: auto;">
          ...
          <div class="card-body">
            ...
            >
              ...
              <div style="line-height: 35px;" v-if="event.event_lang_label">Language:{{event.event_lang_label}}</div>
              <div style="line-height: 35px; color:#f00" v-if="event.event_countdown_label > 0">{{event.event_countdown_label}}</div>
            </div>
