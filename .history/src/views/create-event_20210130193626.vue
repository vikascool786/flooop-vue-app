...
export default {
  ...
  methods: {
    ...
    decrementTimeZone : function(){
      // let i = 1;
      console.log(this.initialTimeZone);
      this.initialTimeZone--
      if (this.eventObj.event_start_minutes >= 0) {
      this.eventObj.event_start_timezone = this.initialTimeZone >= 0 ? this.allTimeZones[this.initialTimeZone - 1] : '';
      }
    },
    ...
    submit(event) {
      ...
      if (this.eventObj.event_start_minutes == "") {
        ...
        this.eventObj.event_start_minutes == 0
        return;
      } else {
