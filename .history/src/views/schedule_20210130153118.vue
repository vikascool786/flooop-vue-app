        ...
        <div class="col-md-10">
             <VueSlickCarousel :arrows="true" :dots="false" :slidesToShow="8">
              ...
              v-for="(event, index) in eventGroups" :key="index" >
               <span style="text-transform: uppercase !important;">{{ event.date.split(", ")[0].substring(0, 3) }} </span> <span style="font-size:20px; font-weight:bold">{{event.date.split(", ")[1].split(" ")[1]}}</span>
              </div>
             </VueSlickCarousel>
