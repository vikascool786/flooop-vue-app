<template>
  <div style="padding-right: 4vw;padding-left: 4vw;" class=" py-xl-4 py-lg-2">
    ...
    >
      ...
      <div class="col-lg-6 col-md-6 col-12"><div style="padding-top: 10px; text-align: center; display: inline-block; padding-right: 15px;"><button id="button" @click="redirectToDetail(event.id)" type="button" class="btn btn-outline-danger" style="width: 100%; border-radius: 15px; color: rgb(177, 172, 172); border-color: rgb(177, 172, 172); font-weight: 500; font-size: 14px; text-align: center; align-items: center;">
          Who's attending
        </button></div><div style="padding-top: 10px; text-align: center; display: inline-block; padding-right: 15px;"><button id="button" @click="redirectToDetail(event.id)" type="button" class="btn btn-outline-danger" style="width: 100%; border-radius: 15px; color: rgb(177, 172, 172); border-color: rgb(177, 172, 172); font-weight: 500; font-size: 14px; text-align: center; align-items: center;">
          Invite Friends
        </button></div><div style="padding-top: 10px; text-align: center; display: inline-block; padding-right: 15px;"><button id="button" @click="EditEvent(event.id)" type="button" class="btn btn-outline-danger" style="width: 100%; border-radius: 15px; color: rgb(177, 172, 172); border-color: rgb(177, 172, 172); font-weight: 500; font-size: 14px;">
          Edit Event
        </button></div><div v-if="showEventStart" style="padding-top: 10px; text-align: center; display: inline-block;"><button id="button" type="button" class="btn btn-outline-danger" style="width: 100%; border-radius: 15px; color: rgb(177, 172, 172); border-color: rgb(177, 172, 172); font-weight: 500; font-size: 14px;">
        ...
        (response) => {
         let data = response.data.records;
          if(data){
            ...
            this.favouriteEvents = data2.sort(function(a, b){return a.event_dateCompare.localeCompare(b.event_dateCompare)});
          }
        },
        (error) => {
          this.content =
