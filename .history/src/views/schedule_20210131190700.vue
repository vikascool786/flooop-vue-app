    ...
    <div class="row" style="margin-top: 80px;">
        <div class="col-md-12">
            <ul class="category-view">
                <li v-for="(category,index) in categories" :key="index" @click="getEvents('Category', category.id)">
    ...
    <div class="row">
        ...
        <div class="col-md-12" v-if="eventGroups.length > 0">
             <VueSlickCarousel :arrows="true" :dots="false" :slidesToShow="8">
               <div
                  class="date-view-li-card"
                  v-for="(event, index) in eventGroups" :key="index" @click="scrollToDate(index)" :id="'dateCard_'+index"  :class="index == 0 ? 'active1' : ''">
...
export default {
  ...
  methods: {
    scrollToDate(index){
      ...
      for (let i = 0; i < 100; i++) {
        document.getElementById("dateCard_"+i).classList.remove("active");
